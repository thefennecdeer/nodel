  ...
  <xsl:template match="/">
    <html lang="en" xsl:version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
      ...
      <body>
        ...
        <script id="multinodeTmpl" type="text/x-jsrender">
         <![CDATA[
          <div class="base">
            <div class="panel panel-default">
              <div class="panel-heading accordion-toggle collapsed" data-target="#nodeselgroup" data-toggle="collapse" aria-expanded="false">
                <div class="panel-title"><h5 class="panel-title">Selected Nodes</h5></div>
              </div>
              <div class="panel-collapse collapse" id="nodeselgroup" aria-expanded="false">
                <div class="panel-body">       
                   <div class="row">
                     <div class="col-sm-12">
                       <div class="flex">
